                                ...
                                <div className="mb-4">
                                    ...
                                    <div className="space-y-3 max-h-60 overflow-y-auto">
                                        {selectedTicket.replies.map((reply, idx) => (
                                            <div key={idx} className={`p-3 rounded-lg ${reply.is_admin_reply ? 'bg-green-50 ml-8' : 'bg-gray-100 mr-8'}`}>
                                        ...
                                        <option value="Closed">Closed</option>
                                            ...
                                            <div className="flex gap-2">
                                                ...
                                                <button
                                                    ...
                                                    className="px-4 py-2 bg-[#00674F] text-white rounded hover:bg-[#004938]"
                                                >
                                                    Send Reply
                                                </button>
                                            </div>
